...
sec_joined_zone_data=sec_data_2022_joined_4%>%
  ...
  mutate(def_success_in_redzone_vs_not_divided_by_nfl_avg=official_stat_2/official_stat)%>%
  select(defteam, def_success_in_redzone_vs_not_divided_by_nfl_avg)
