...
> To find averages of variables such as "play type by time remaining in half or game," we can compare average play types for certain time intervals and then subtract the average from one time by the average of another to find the difference.
>
