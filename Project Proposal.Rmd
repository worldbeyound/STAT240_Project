...
> To find averages of variables such as "play type by time remaining in half or game," we can compare average play types for certain time intervals and then subtract one time by another to find the difference.
>
