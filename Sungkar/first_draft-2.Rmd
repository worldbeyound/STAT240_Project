...
## Background
  ...
  Variables three and four are simpler. Variable three simply represents third down conversion rate and variable four represents total touchdowns per game. For all variables, there is a value representing the NFL and the Superbowl winner for each year. 
